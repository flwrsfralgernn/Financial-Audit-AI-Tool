...
def combine():
    expense_etd_df = pd.read_excel("./CombineAndFormatData/Expense - Expense Type Detail (SLO) 2024.xlsx", sheet_name="Details_1", header=8)
    employee_active_df = pd.read_excel("./CombineAndFormatData/EE Active.xlsx", sheet_name="EE-Active")
    ...
    expense_cf_df = pd.read_excel("./CombineAndFormatData/Expense - Expense Reports with CF Information and Comments (2).xlsx", sheet_name="Summary_1", header=6)
    ...
    expense_ppsa_df = pd.read_excel("./CombineAndFormatData/Expense - Processor Paid Summary Account.xlsx", sheet_name="Page1_1", header=4)
    ...
    request_rit_df = pd.read_excel("./CombineAndFormatData/Request - Risk International Travel with Header Comments (1).xlsx", sheet_name="Request - Risk International_1", header=7)
    ...
    export_path = "data/CombineAndFormatData/master_expense_report.xlsx"
